...
// Best-effort exit after a successful jailbreak.
function exitBrowserAfterJailbreak() {
  try {
    window.log("\nJailbreak activé — fermeture du navigateur...", "green");
  } catch (_) {}
  setTimeout(function () {
    try { window.close(); } catch (_) {}
    // Some PS4 WebKit builds block window.close(); leave the user on a safe blank page.
    setTimeout(function () {
