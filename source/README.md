...
[Blu-ray BD-RW disc - Google Search](https://www.google.com/search?q=blu+ray+bdrw+disc)

[Releases · GoldHEN/henloader_lp](https://github.com/GoldHEN/henloader_lp/releases)

[GoldHEN v2.4b18.7](https://ko-fi.com/s/5d29f9e29c)

[ImgBurn Official Site](https://www.imgburn.com)

[PKG-Zone](https://pkg-zone.com)


## 13.52 Loader Profile

This source now detects firmware **13.52** and switches to a safe payload-loader profile.
The embedded payload path is `/disc/BDMV/AUXDATA/hen.bin`.

**Important:** the Lapse/Poops exploit implementations included in this source are not a verified 13.52 exploit chain. Therefore the loader deliberately does not execute the older exploit code on 13.52. A real 13.52 jailbreak requires a separately verified 13.52 exploit/kernel chain.

The 13.52 profile is intended for loading a compatible payload after jailbreak, not for claiming that this BD-J source itself exploits 13.52.
