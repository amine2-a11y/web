...
public class KernelOffset
{
  ...
  /**
   * Returns a stable profile name selected from the exact detected PS4 firmware.
   * This keeps firmware selection automatic instead of tying the loader to one
   * hard-coded version.
   */
  public static String getLoaderProfile(String firmware) {
    ...
    if (firmware.equals("11.00")) return "FW_11.00";
    if (firmware.equals("9.00")) return "FW_9.00";
    return "unsupported";
  }
