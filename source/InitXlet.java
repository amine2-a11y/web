          ...
          public void run() {
            try {
              ...
              if (System.getSecurityManager() != null) {
                ...
                String loaderProfile = KernelOffset.getLoaderProfile(str);
                InitXlet.console.println("Firmware: " + str);
                InitXlet.console.println("Loader profile: " + loaderProfile);
                ...
                if ("FW_13.52_PAYLOAD_ONLY".equals(loaderProfile)) {
                  ...
                  InitXlet.console.println("No verified exploit profile for firmware: " + str);
                } else {
                  while (true) {
                    byte b = 0; int i = 0;
