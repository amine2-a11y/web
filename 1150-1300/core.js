let DRAIN_COUNT = 512;
const IS_FAST_1252 = /PlayStation\s+4[\/ ]12\.52/i.test(navigator.userAgent || "");
const AUTO_RETRY_DELAY_MS = IS_FAST_1252 ? 10 : 50;
...
const CAPTURE_DELAY_MS = IS_FAST_1252 ? 10 : 50;
const COMPOSE_DELAY_MS = IS_FAST_1252 ? 25 : 100;
...
function scheduleSafeRetry(reason) {
    ...
    setTimeout(() => {
        ...
        startAttempt();
    }, Math.max(AUTO_RETRY_DELAY_MS, IS_FAST_1252 ? 250 : 750));
}
